...
def prediction_16(Data,Tree):
    ...
    while (Tree.branching!=1) and (Tree.branching!=-1):
...
#copy original prune tree
prune_tree_origin = prune_tree.copy()
...
def prediction_tree(Data,Tree):
    ...
    if  (Tree.branching ==1) or (Tree.branching ==-1):
        #print("here ", Tree)
...
print("Ein(no value update)")
print(Ein_16)

print("Eout(no value update)\n")
print(Eout_16)
